...
urlpatterns = [
    ...
    path('<slug:slug>/editrelease/', views.EditRelease.as_view(), name='edit_release'),
    path('<slug:slug>/deleterelease/', views.DeleteRelease.as_view(), name='delete_release'),
    path('<slug:slug>/deletereview/', views.DeleteReview.as_view(), name='delete_review'),
    path('<slug:slug>/editreview/', views.EditReview.as_view(), name='edit_review'),
    path('<slug:slug>/', views.ArticleDetail.as_view(), name='article_detail'),
    path('<slug:slug>/edit_article/', views.EditArticle.as_view(), name='update_article'),
    path('<slug:slug>/delete_article/', views.DeleteArticle.as_view(), name='delete_article'),
